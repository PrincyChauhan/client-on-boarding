  ...
  return (
    <div className="w-[280px] h-[2092px] p-4 bg-white border border-[#EAECF0] rounded-md">
      ...
      <div className="flex flex-wrap gap-3 mt-3 justify-between">
        <div className="flex flex-col items-center justify-center border border-[#EAECF0] rounded-lg gap-1 w-[110px] h-[72px] bg-gray-50">
      ...
      <div class="h-px w-[233px] bg-[#EAECF0] mt-4"></div>
